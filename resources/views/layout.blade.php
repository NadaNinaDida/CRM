            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="white-space: nowrap;">RDV chez nous </th>
                ...
                <tbody>
                    @foreach ($clients as $client)
                        <tr>
                            ...
                            <td>
                              <img src="{{url('img/rdv.png')}}" alt="" width="30px"> <br>
                             <span>{{ $client->visites->count() }}</span>
                            </td>
                         <td><form action="{{ route('clients.destroy', ['id' => $client->id]) }}" method="POST">
                          @csrf
                          @method('DELETE')
                          <button type="submit" style="border: none;">
                            ...
                            <td>
                              <a href="/clients/showClient/{{ $client->id }}">
