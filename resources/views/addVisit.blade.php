                        ...
                        <div class="col-md-6">
                            <form action="{{ route('visits.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="datev" name="datev" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="commentaires" rows="3">{{ old('body', $post->body ?? null) }}</textarea>
                                </div>
